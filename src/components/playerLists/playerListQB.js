...
export const playersQB = [
    ...
    players: [
      {
        ...
        ypc: 7.5,
        img:
          'http://images.performgroup.com/di/library/omnisport/32/a/brett-hundley-102217-usnews-getty-ftr_1icd7ro62lkpj1wh0qaw0umjho.jpg?t=1165142279&w=450&quality=70'
      },
      {
        displayName: 'Deshaun Watson',
        ypc: 7.47,
        img:
          'https://usatcardswire.files.wordpress.com/2017/11/usatsi_103793661.jpg?w=590&h=300&crop=1'
      },
      {
        displayName: 'Dak Prescott',
        ypc: 6.26,
        img:
          'https://usatcowboyswire.files.wordpress.com/2016/12/usatsi_9716213.jpg?w=690&h=300&crop=1'
      },
      {
        displayName: 'Russel Wilson',
        ypc: 6.17,
        img:
          'http://www.nbcsports.com/philadelphia/sites/csnphilly/files/styles/article_hero_image/public/2017/12/04/usatsi_10459635_1920x1080_1108870211829.jpg?itok=iEQdJc0w'
      },
      {
...

  {
    ...
    players: [
      ...
      },
      {
        ...
        QBrating: 91.4,
        img: 'https://s.hdnux.com/photos/70/30/77/14782439/3/600x350.jpg'
      },
      {
        displayName: 'Dak Prescott',
        QBrating: 86.6,
...

  {
    ...
    players: [
      ...
      },
      {
        ...
        int: 14,
        img:
          'https://us-east-1.tchyn.io/snopes-production/uploads/2017/07/steelers.jpg?resize=725,402'
      },
      {
  ...
  {
    gameType: 'QBcompletion',
    players: [
      {
        displayName: 'Alex Smith',
        completions: 341,
        img:
          'http://www.nbcsports.com/washington/sites/csnma/files/styles/article_hero_image/public/2018/02/10/usatsi_10394047.jpg?itok=gUgHEcdJ'
      },
      {
        displayName: 'Blake Bortles',
        completions: 315,
...

  {
    ...
    players: [
      ...
      },
      {
        ...
        passYards: 3504,
        img:
          'https://nbcprofootballtalk.files.wordpress.com/2017/08/835540054-e1508514817300.jpg?w=740&h=406&crop=1'
      },
      {
...

  {
    ...
    players: [
      ...
      },
      {
        ...
        ffpts: 359,
        img:
          'https://bloximages.newyork1.vip.townnews.com/purdueexponent.org/content/tncms/assets/v3/editorial/0/48/048073ca-2740-11e8-b1c5-7fd39f8c7d4d/5aa8a4d73c28b.image.jpg'
      },
      {
        displayName: 'Carson Wentz',
        ffpts: 342,
